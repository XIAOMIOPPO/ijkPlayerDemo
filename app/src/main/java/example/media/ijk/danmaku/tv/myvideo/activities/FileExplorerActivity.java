...
import example.media.ijk.danmaku.tv.myvideo.application.AppActivity;
import example.media.ijk.danmaku.tv.myvideo.application.Settings;
import example.media.ijk.danmaku.tv.myvideo.eventbus.FileExplorerEvents;
import example.media.ijk.danmaku.tv.myvideo.fragments.FileListFragment;
